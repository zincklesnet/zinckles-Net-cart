 ...
 * Description: Unified multisite cart — aggregate WooCommerce products from multiple subsites into a single checkout on the main site, with mixed currency support, MyCred (ZCreds) integration, parent/child orders, and inventory sync.
...
/* ── Constants ────────────────────────────────────────────── */
define( 'ZNC_VERSION',     '1.0.0-prototype' );
...
function znc_bootstrap() {
    ...
    /* ── Network-level settings (always available) ──────── */
    $network_settings = new ZNC_Network_Settings();
